        ...
        <div class="container-login100" style="background-color:grey;">
            <div class="wrap-login100">
                <form action="ControllerServlet" method="get" class="login100-form validate-form">
                    ...
                    <div class="wrap-input100 validate-input" data-validate="Enter body">
                        <input class="input100" type="text" name="body" placeholder="Body">
                       
                    </div>

                    
                    <div class="container-login100-form-btn">
                        <button name="buttonName" value="update"class="login100-form-btn">
							Update Post
						</button>
					</div>
